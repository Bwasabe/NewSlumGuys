...
void SceneMgr::Init()
{
	...
	m_arrScene[(UINT)SCENE_TYPE::TIP] = new TipScene;
	m_arrScene[(UINT)SCENE_TYPE::TIP]->SetName(L"Tip Scene");

	m_arrScene[(UINT)SCENE_TYPE::ENDING_SCENE] = new EndingScene;
	m_arrScene[(UINT)SCENE_TYPE::ENDING_SCENE]->SetName(L"EndingScene");
